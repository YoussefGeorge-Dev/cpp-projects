...
// * Shared struct/constant used by Question 1 and Question 2
struct Student
{
    string name;
    int ID;
...
int main()
{
    ...
    do
    {
        ...
        cout << "                LAB 09 MENU               \n";
        cout << "=========================================\n";
        cout << " 1. Student Struct: Write, Average, Append\n";
        cout << " 2. Student Struct via Separate Functions\n";
        cout << " 3. Product Bill from Inventory File\n";
        cout << " 4. Exception: Age Restriction\n";
        cout << " 5. Exception: University ID Validation\n";
        cout << " 6. Exception: Array Out of Bounds\n";
        cout << " 0. Exit\n";
        cout << "=========================================\n";
